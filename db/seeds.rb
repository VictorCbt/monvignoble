...
offered_services3 = OfferedService.create!(title: "Etiquette de bouteille personnalisée", description: "recevez chaque année des caisse de notre vin", investment_id: investment5.id)
offered_services4 = OfferedService.create!(title: "Découverte des vendanges", description: "participez à des dégustations d'exceptions", investment_id: investment5.id)
offered_services5 = OfferedService.create!(title: "Etiquette de bouteille personnalisée", description: "recevez chaque année des caisses de notre vin avec votre propre étiquette", investment_id: investment5.id)

puts "creation #{OfferedService.count} offered services"


UsersGroup.create!(user_id: user1.id, group_id: group1.id, status: 'validate')
UsersGroup.create!(user_id: user3.id, group_id: group1.id, status: 'validate')
UsersGroup.create!(user_id: user4.id, group_id: group2.id, status: 'validate')
UsersGroup.create!(user_id: user2.id, group_id: group2.id, status: 'validate')
