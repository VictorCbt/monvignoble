...
investment1 = Investment.create!(investment_name: "Rouges Bordeaux", punchline: "Les vins de Bordeaux sont mondialement connus et font la gloire de la France sur toutes les tables du monde.", winemaker_name: "Robert", domaine_name: "Château Dauzac", description: "En 2009, les superficies déclarées sont de 38 490 hectares en rouges, 700 ha en clairets, 4.725 ha en rosés et 6.040 ha en blancs.", bio: true, region: "Bordeaux", ticket_amount: 500, investment_total: 5000, share_available: 10, total_share: 10, profitability: 2, winemaker_profile: "Vigneron installé", deferred_remuneration: true, user_id: user1.id)
investment2 = Investment.create!(investment_name: "Les rois du Bourgogne", punchline: "La réputation des grands domaines viticoles en Bourgogne s’est faite dès le règne de Charlemagne.", winemaker_name: "Jean", domaine_name: "Château de Chasselas", description: "Les 5 principales zones viticoles sont : le Chablis, la Côte d’Or, la Côte Chalonnaise, Le Mâcon, et le Beaujolais (Morgon).", bio: true, region: "Bourgogne", ticket_amount: 3000, investment_total: 30000, share_available: 3, total_share: 30, profitability: 3 , winemaker_profile: "Jeune vigneron", deferred_remuneration: true, user_id: user2.id)
investment3 = Investment.create!(investment_name: "AOP", punchline: "Les 75 pourcents de vins rouges produits à partir de syrah peuvent comporter (à hauteur de 15 pourcents maximum, comme en Côte Rôtie avec le viognier)", winemaker_name: "Maurice", domaine_name: "Cheateau de la Tour-Cirée", description: "Les terroirs sont très divers et chaque parcelle bien spécifique porte un nom bien connu des passionnés de cette appellation de prestige : Greffieux, Méal, Bessards, Rocoules, etc.", bio: false, region: "Hermitage", ticket_amount: 10000, investment_total: 100000, share_available: 2, total_share: 10, profitability: 5, winemaker_profile: "Jeune vigneron", deferred_remuneration: false, user_id: user3.id)
...
puts "creation #{OfferedService.count} services offerts"

group1 = Group.create!(status: "privé", region: "Bordeaux", designation: "Margaux", winemaker_profil: "Jeune vigneron", votes:"4", profitability: 2, share_available: 3, investment_total: 3000, ticket_amount: 1000, investment_id: investment1.id, user_id: user1.id)
group2 = Group.create!(status: "publique", region: "Bourgogne", designation: "Saint-Véran", winemaker_profil: "Vigneron installé", votes:"3", profitability: 3, share_available: 10, investment_total: 15000, ticket_amount: 5000, investment_id: investment2.id, user_id: user4.id)
