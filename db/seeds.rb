...
investment8 = Investment.create!(investment_name: "Achat d'une parcelle de Romanée Conti", punchline: "La réputation des grands domaines viticoles en Bourgogne s’est faite dès le règne de Charlemagne.", winemaker_name: "Jean", domaine_name: "Domaine de la Romanée Conti", description: "Les 5 principales zones viticoles sont : le Chablis, la Côte d’Or, la Côte Chalonnaise, Le Mâcon, et le Beaujolais (Morgon).", bio: true, region: "Bourgogne", designation: "Romanée-Conti", remuneration: "1 bouteille du domaine",ticket_amount: 100000, investment_total: 1500000, share_available: 15, total_share: 15, profitability: 3 , winemaker_profile: "Vigneron installé", deferred_remuneration: false, user_id: user7.id)
